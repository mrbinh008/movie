    ...
    <div class="login">
        <div class="container">
            ...
            <div class="login-form">
                <form action="" method="post" name="resetpass" onsubmit="return matchpass()">
                    <input type="password" placeholder="Nhập mật khẩu mới" name="password">
                    <input type="password" placeholder="Nhập lại mật khẩu" name="password_chk">
...
<script type="text/javascript">
    function matchpass(){
        var firstpassword=document.resetpass.password.value;
        var secondpassword=document.resetpass.password_chk.value;
